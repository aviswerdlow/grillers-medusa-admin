...
if (process.env.TEST_TYPE === "integration:inventory") {
  module.exports.testMatch = ["**/integration-tests/inventory/*.spec.[jt]s"];
} else if (process.env.TEST_TYPE === "integration:catalog") {
