...
| Materialized segment and calendar audience selection | [Refresh receipt candidate](segment-audience-refresh-336.md) distinguishes unavailable from empty, saves complete membership atomically and holds stale/changed/failed results. This does not establish source classification, original recipient/permission, queued-flow eligibility or permission to activate. |
