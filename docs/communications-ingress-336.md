...
| Communications native customer and cart email recovery | Saved customer and cart sources, atomic cart expiration, original email permission and per-step vetoes now have source candidates. Cart email/holdout outcome measurement retains lineage and analytics exclusions. Account welcome, calendar/segment audiences, SMS, provider callbacks and subsequent custom flow chains still need their own original-purpose classification and controlled receipts. |
